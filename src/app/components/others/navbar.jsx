...
export default function Navbar() {
    return (
        <div className="Theme1 fixed w-full Quantico font-bold z-30 grid grid-flow-col grid-cols-3 place-content-center place-items-center p-4 text-lg min-[1050px]:text-xl min-[1200px]:text-2xl">
            ...
            <div>
                ...
                className="Big cursor-pointer rounded-[10%] mx-auto w-[150px] h-[50px]"/>
                </Link>
            </div>
