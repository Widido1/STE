...
// Constante para el número de WhatsApp (cámbialo por el real)
      ...
      <div className="relative">
        ...
        {menuAbierto && (
          <div className="flex flex-col gap-2 absolute top-full left-0 mt-2 bg-[--azulOscuroT] text-[--white1] rounded shadow-lg z-50 w-48">
            <Link className="cursor-pointer w-full hover:bg-[--azulClaro] py-1 px-2" onClick={() => setMenuAbierto(false)} href="/camaras">
              <div className="w-full">Cámaras de seguridad</div>
            </Link>
            <Link className="cursor-pointer w-full hover:bg-[--azulClaro] py-1 px-2" onClick={() => setMenuAbierto(false)} href="/alarmas">
              Alarmas
            </Link>
            <Link className="cursor-pointer w-full hover:bg-[--azulClaro] py-1 px-2" onClick={() => setMenuAbierto(false)} href="/gps">
              GPS
            </Link>
            <Link className="cursor-pointer w-full hover:bg-[--azulClaro] py-1 px-2" onClick={() => setMenuAbierto(false)} href="/vial">
              Analítica
            </Link>
...
// Componente Logo (fuera de Navbar)
function Logo() {
  return (
...
// Componente WhatsAppButton (fuera de Navbar)
...
export default function Navbar() {
  return (
    <>
      {/* Layout para pantallas >= 1000px */}
      <div className="hidden bg-[--azulOscuroT] min-[1000px]:flex flex-wrap items-center justify-between w-full Montserrat font-semibold z-30 px-4 py-4 text-xs min-[600px]:text-sm min-[800px]:text-base gap-2 min-[600px]:gap-4">
        <Logo />
        <MenuItems />
        <WhatsAppButton />
      </div>
      ...
      {/* Layout para pantallas < 1000px */}
      <div className="flex flex-col bg-[--azulOscuroT] min-[1000px]:hidden w-full Montserrat font-semibold z-30 text-[8px] min-[350px]:text-[10px] min-[600px]:text-xs min-[800px]:text-base px-4 py-4 gap-4">
