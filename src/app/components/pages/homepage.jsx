...
export default function HomePage() {
  const itemclass = "Shine OdibeeSans text-xl text-[--white1] text-center pl-8";
  const items = [
  ...
  return (
    <div className="grid bg-[--negro1]">
      ...
      <div className="grid h-[95vh] bg-black/50 z-20">
        ...
        <div className="grid grid-flow-col place-content-center place-items-center z-20 ">
          <div className="grid grid-flow-row place-content-center place-items-center gap-8">
            ...
            <div className="OdibeeSans text-[--azulClaro] text-4xl">Instalación profesional, configuración completa y soporte técnico.</div>
            <div className="OdibeeSans BoxShine Bigger text-[--white1] bg-[--azulClaro] rounded-full cursor-pointer w-[400px] text-5xl py-4 text-center">Contactanos</div>
          </div>
          <div className="grid grid-flow-row place-items-center place-self-end text-center OdibeeSans
          rounded-[5%] bg-[--azulT] text-[--white1] w-[400px] h-[600px] text-3xl mx-20">
            <div>Cotizá tu alarma llamando al</div>
            <div className="Shine text-5xl font-bold text-[--white1]">+5493424220579</div>
            ...
            <div className="BoxShine Bigger text-center bg-[--azulClaro] text-[--white1] rounded-full cursor-pointer w-[200px] py-2 ">Enviar</div>
      ...
      <div>
        <div>Estos son los servicios que ofrecemos</div>
